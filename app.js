...
let weekDay = days[today.getDay()];//Días de la semana [Lunes, martes, miercoles,...]
let monthDay = today.getDate();//Días del mes[1, 2, 3,...]
let month = today.getMonth();//Mes [Enero, Febrero, Marzo,...]
